...
```{r}
data200022 = read.csv("C:/Users/Runzhao Xie/Desktop/2000-2022.csv")
beforecovid.ts <- ts(data200022[,2],start=c(2000,1),end=c(2022,35),freq=52)
beforecovid.ts
```
...
accuracy(arima(beforecovid.ts,c(2,1,3)))
AIC(arima(beforecovid.ts,c(2,1,3)))
BIC(arima(beforecovid.ts,c(2,1,3)))
