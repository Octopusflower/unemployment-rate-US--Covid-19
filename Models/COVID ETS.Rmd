...
beforecovid.ts <- ts(data[,2],start=c(1967,1),end=c(2022,31),freq=52)
AfterCOVID.ts <- ts(data[,2],start=c(2010,1),end=c(2022,31),freq=52)
```

```{r}
#Define Functions
beforecovid.ses = ses(beforecovid.ts, h=100)
beforecovid.holt = holt(beforecovid.ts, h=100)
beforecovid.holtdamp = holt(beforecovid.ts, damped = TRUE, h=100)
```
