...
```{r}
data = read.csv("C:/Users/Runzhao Xie/Desktop/2000-2022.csv")
beforecovid.ts <- ts(data[,2],start=c(2000,1),end=c(2022,35),freq=52)
beforecovid.ts
```
...
```
```{r}
AIC(beforecovid.model.full)
BIC(beforecovid.model.full)
```
